...
/* @var $searchModel backend\models\WebSearch */
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox-title">
                <h5>站点管理</h5>&nbsp;&nbsp;<font>(共<?= $dataProvider->getTotalCount()?>条记录)</font>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    return \backend\models\Web::$statusShow[$model->status];
                },
                'filter' => \backend\models\Web::$statusOption
            ],
            [
