...
<div id="wrapper">
                    ...
                    <ul class="nav nav-second-level">
                        <?php if($val['child']):?>
                            <?php foreach ($val['child'] as $k=>$v):?>
                                <?php if($v['child']):?>
                                    <li>
                                        <a href="<?=Url::to([$v['route']]);?>"><?=$v['name'];?><span class="fa arrow"></span></a>
                                        <ul class="nav nav-third-level">
                                            <?php foreach ($v['child'] as $vv):?>
                                                <li><a class="J_menuItem" href="<?=Url::to([$vv['route']]);?>"><?=$vv['name'];?></a></li>
                                            <?php endforeach;?>
                                        </ul>
                                    </li>
                                <?php else:?>
                                    <li>
                                        <a class="J_menuItem" href="<?=Url::to([$v['route']]);?>" data-index="<?=$k;?>"><?=$v['name'];?></a>
                                    </li>
                                <?php endif;?>
                            <?php endforeach;?>
                        <?php endif;?>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer fixed">
            ...
            <div>
                Copyright Example Company © 2014-2017
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
